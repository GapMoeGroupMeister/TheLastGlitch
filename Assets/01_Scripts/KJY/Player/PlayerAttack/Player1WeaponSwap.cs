...
public class Player1WeaponSwap : MonoBehaviour
{
    public static Player1WeaponSwap Instance;
            ...
            if (!_isSwaping)
            {
                ...
                if (_player.activeSelf == true)
                {
                    ...
                    else if (_weapon2.activeSelf == true)
                    {
                        ...
                        _swapSequence.Append(_weapon2.transform.DOLocalRotate(new Vector3(0, 0, 70), 0.4f));
